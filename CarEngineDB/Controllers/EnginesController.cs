...
namespace CarEngineDB.Controllers
{
    public class EnginesController : Controller
    {
        ...
        public EnginesController(CarDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EngineId,EngineType")] Engine engine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EngineId,EngineType")] Engine engine)
        {
